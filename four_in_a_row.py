...
class FourInARow:
    ...
    Attributes:
    n: The size of the game board (n by n)
    p1_human: if the first player is human or computer
    p2_human: if the second player is human or computer
    board: The game board (n by n)
...
def load_game() -> FourInARow:  # pragma: no cover
    ...
    True
    """
    input_string = input("Enter game parameters (<n> <is_p1_human?> " "<is_p2_human?>):\n")
